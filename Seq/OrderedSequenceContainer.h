...
class OrderedSequenceContainer : public SequenceContainer
{
	...
	public:
		 ...
		 */
		virtual vector<int> getContent(unsigned int i) const throw (IndexOutOfBoundsException) = 0;
		 ...
		 * @throw IndexOutOfBoundsException If the position does not match any sequence in the container.
		 */
		virtual string toString(unsigned int i) const throw (IndexOutOfBoundsException) = 0;
		 ...
		 * @throw IndexOutOfBoundsException If the position does not match any sequence in the container.
		 */
		virtual const Sequence * getSequence(unsigned int i) const throw (IndexOutOfBoundsException) = 0;
		 ...
		 */
		virtual void setSequence(unsigned int i, const Sequence & sequence, bool checkNames) throw (Exception) = 0;
		 ...
		 * the container.
		 */
		virtual Sequence * removeSequence(unsigned int i) throw (IndexOutOfBoundsException) = 0;
		 ...
		 * the container.
		 */
		virtual void deleteSequence(unsigned int i) throw (IndexOutOfBoundsException) = 0;

		/**
		 * @brief Get the name of a particular sequence.
		 *
		 * @param i The position of the sequence.
		 * @return The name of the sequence at position 'i'.
		 * @throw IndexOutOfBoundsException If the position does not match any sequence in
		 * the container.
		 */
		virtual string getName(unsigned int i) const throw (IndexOutOfBoundsException) = 0;

		/**
		 * @brief Get comments of a particular sequence.
		 *
		 * @param i The position of the sequence.
		 * @return The comments associated to sequence at position 'i'.
		 * @throw IndexOutOfBoundsException If the position does not match any sequence in
		 * the container.
		 */
		virtual Comments getComments(unsigned int i) const throw (IndexOutOfBoundsException) = 0;
